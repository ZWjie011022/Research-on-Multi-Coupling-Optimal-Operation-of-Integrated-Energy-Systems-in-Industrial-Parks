clear; clc;
% =========================================================================
% 园区综合能源系统 4典型日 全年容量优化配置模型（对照场景：无电储能）
% 【HFC灵活电热比版】
% 列 1: 春季 (91天)  列 2: 夏季 (91天)
% 列 3: 秋季 (91天)  列 4: 冬季 (92天)
% 
% 【核心逻辑】：
% 1. 强制不配置电储能。优化完全不考虑碳排放与碳交易成本，纯经济驱动。
% 2. 引入真实风光出力数据，允许配置风光。
% 3. 氢燃料电池（HFC）电热效率之和固定为0.9，电热比在[0.7, 2]范围内灵活调节。
% =========================================================================
...
title('微电网全年四季连续电功率平衡 (无电储能对照组)', 'FontSize', 14);
...
title('电储能 SOC 与 数据中心温控 四季动作协同 (无电储能对照组)', 'FontSize', 14);
